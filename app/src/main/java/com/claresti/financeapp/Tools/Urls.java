...
public class Urls {
    ...
    public static final String HOST = "http://192.168.1.70:8000/api/";
    ...
    public static final String REGISTERMOVEMENT = HOST + "accounts/register_movement/";
    ...
    public static final String VIEWUSERMOVEMENTS = HOST + "accounts/view_user_movements/";
}
